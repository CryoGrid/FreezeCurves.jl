...
"""
    swpmodel(swp::SoilWaterProperties; θfrac_dispersion=10.0, θres_dispersion=10.0)

Reparameterizes residual and saturated water contents in `SoilWaterProperties` as `θres` and `θfrac` where
```math
...
"""
@model function swpmodel(swp::SoilWaterProperties; θfrac_dispersion=10.0, θres_dispersion=10.0)
...
@model function sfccmodel(
    ...
    θsat, θtot, θres = @submodel swpmodel(SoilWaterProperties(fc); θfrac_dispersion, θres_dispersion)
